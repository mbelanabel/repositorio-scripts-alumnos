#!/bin/bash
# Ejercicio de simulacro 1  (script de refuerzo: nº20)
#jt. Octubre 2017
#
# JUAN TONDA
# 20.-
...
# keywords: groupadd; adduser (comentadas, para su implementación en un entorno de pruebas, y posteriormente pasar a real)
