...
clear
 tput cup 1 1   ; echo "Calcular el día en que naciste" 
 tput cup 2 10  ; read -p "Indicame tu nombre: " nombre 
 tput cup 3 10  ; read -p "Introduzca el dia: " dia  
 tput cup 5 10  ; read -p "Introduzca el mes: " mes
 tput cup 7 10  ; read -p "Introduzca el año: " anio
...
if [ $dia -lt 10 ]; then
 ...
 x=`cat dia`
     ...
     case $x in
 	  2) dia_semana="LUNES" ;;
	  3) dia_semana="MARTES" ;;
          4) dia_semana="MIERCOLES" ;;
          5) dia_semana="JUEVES" ;;
          6) dia_semana="VIERNES" ;;
          7) dia_semana="SÁBADO" ;;
          8) dia_semana="DOMINGO" ;;
 ...
 # sleep 20 
 tput cup 10 5  ; echo "Se corresponde al dia de la semana: " $dia_semana
